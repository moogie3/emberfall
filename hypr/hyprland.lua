-- #######################################################################################
-- UNIFIED HYPRLAND LUA CONFIG (MIGRATED FROM .CONF)
-- #######################################################################################
...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd('sh -c "pkill waybar; pkill hyprpaper; pkill swaync; waybar & hyprpaper & swaync &"'))
...
-- Include GUI config from old setup if needed
-- dofile("/home/emberfall/.config/hypr/hyprland-gui.conf")